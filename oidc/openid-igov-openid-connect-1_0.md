...
Note: examples in the original iGov profile are sometimes inconsistent or even invalid, these have been corrected without explicit formatting in this profile along with other changes.
...
In addition to the requirements specified in Section ~~2.1.1~~ **1.3.3.1** of the iGov-**NL** OAuth2
...
<dt>redirect_uri</dt>
<dd>REQUIRED. Indicates a valid endpoint where the client will receive the authentication response. See (<b>OpenID</b> core section 3.1.2.1)</dd>
...
In addition to the requirements specified in Section ~~2.1.2~~ **1.3.3.3** of the iGov-**NL** OAuth2
